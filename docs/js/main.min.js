...
var _nojs = require("./modules/nojs");
...
},{"./modules/form-validate/form":3,"./modules/menu":9,"./modules/nojs":10,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
var initMenu = function initMenu() {
  ...
  var menuLink = document.querySelectorAll('.header__site-menu a[href^="#"]');
  ...
  var overlayClose = function overlayClose(evt) {
  ...
  menuLink.forEach(function (closer) {
    return closer.addEventListener('click', closeMenu);
  });
};
exports.initMenu = initMenu;

},{"../utils/focus-lock":11,"../utils/scroll-lock":14}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initNoJs = void 0;
var initNoJs = function initNoJs() {
  if (document.querySelector('.no-js')) {
    document.querySelector('.no-js').classList.remove('no-js');
  }
};
exports.initNoJs = initNoJs;
